...
def train_knn(x_train, y_train, x_cv, y_cv):
...
def train_decision_tree(x_train, y_train, x_cv, y_cv):
...
def predict_test(clf):
    ...
    df.to_csv('/vagrant/examples/sara/titanic-solution-iteration-5.csv', index=False)
...
#clf = train_knn(x_train, y_train, x_cv, y_cv)

#clf = train_decision_tree(x_train, y_train, x_cv, y_cv)
